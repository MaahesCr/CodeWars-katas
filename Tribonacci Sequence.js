...
function tribonacci(signature,n){
  ...
  function tribonacciTwo(signature,n){
    for (let i = 3; i < n; i++){
        signature.push(signature[i-3]+signature[i-2]+signature[i-1]);
    }
    ...
    console.log(tribonacciTwo([0,1,1],10));
    console.log(tribonacciTwo([1,2,3],10));
    console.log(tribonacciTwo([3,2,1],10));
    console.log(tribonacciTwo([0,1,1],1));
    console.log(tribonacciTwo([0,1,1],0));
